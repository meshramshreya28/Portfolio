...
const Hero = () => {
  ...
  return (
    <section id="hero" className="section-wash min-h-screen flex flex-col justify-between px-6 md:px-12 pt-36 pb-12 relative">
      ...
      <div className="flex-1 flex items-center relative z-10">
        <div className="w-full">
          ...
          <div className="overflow-hidden">
            <p ref={addLineRef} className="heading-xl text-muted opacity-0"
      ...
      <div ref={btnRef} className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6 opacity-0 relative z-10">
        ...
        <div className="flex gap-4">
          <a href="#projects" className="btn-magnetic px-7 py-3 rounded-full border border-white/10 text-cream text-sm font-medium hover:border-white/30 transition-colors duration-300" {...magnetic}>
            <span className="btn-inner">View Work</span>
          </a>
          <a href="#contact" className="btn-magnetic px-7 py-3 rounded-full text-bg text-sm font-semibold transition-colors duration-300 accent-bg" {...magnetic}>
